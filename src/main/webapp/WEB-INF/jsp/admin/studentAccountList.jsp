			...
			<div class="col-md-10 column right">
				<div style="padding-top: 12px;">
					<a class="btn btn-default"
						href="${pageContext.request.contextPath}/studentAccount/addForm">添加</a>
				</div>
				<div class="row clearfix">
					...
					<table class="col-md-8 table table-striped">
						...
						<tbody align="center">
							<c:forEach items="${SAs }" var="n">
								<tr>
									<td>${n.account }</td>
									<td>${n.password }</td>
									<td><a
										href="${pageContext.request.contextPath}/studentAccount/findByAccount?account=${n.account}">edit</a></td>
									<td><a
										href="${pageContext.request.contextPath}/studentAccount/delete?account=${n.account}">delete</a></td>
								</tr>
							</c:forEach>
						</tbody>
					</table>
