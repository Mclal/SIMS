			...
			<div class="col-md-10 column right">
				<div style="padding-top: 12px;">
					<a class="btn btn-default"
						href="${pageContext.request.contextPath}/adminAccount/addForm">添加</a>
				</div>
				<div class="row clearfix">
					...
					<table class="col-md-8 table table-striped">
						...
						<tbody align="center">
							<c:forEach items="${AAs }" var="n">
								<tr>
									<td>${n.account }</td>
									<td>${n.password }</td>
									<td><a
										href="${pageContext.request.contextPath}/adminAccount/findByAccount?account=${n.account}">edit</a></td>
									<td><a
										href="${pageContext.request.contextPath}/adminAccount/delete?account=${n.account}">delete</a></td>
								</tr>
							</c:forEach>
						</tbody>
					</table>
