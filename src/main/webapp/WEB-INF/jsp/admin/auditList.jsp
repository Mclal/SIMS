		...
		<div class="row clearfix">
			<div class="col-md-2 column left">
				<ul class="nav nav-stacked nav-pills">
					...
					<li class="active"><a href="../auditList/list">信息审核</a></li>
						...
						<tbody align="center">
							<c:forEach items="${ALs }" var="n">
								<tr>
									...
									<td>${n.class_ }</td>
									<td>${n.id }</td>
									<td>${n.flag==1?"已通过":"未通过" }</td>
									<td><a
										href="${pageContext.request.contextPath}/auditList/update?no=${n.no}&flag=1">√</a></td>
									<td><a
										href="${pageContext.request.contextPath}/auditList/update?no=${n.no}&flag=0">×</a></td>
									<td><a
										href="${pageContext.request.contextPath}/auditList/delete?no=${n.no}">delete</a></td>
								</tr>
							</c:forEach>
						</tbody>
					</table>
