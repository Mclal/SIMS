			...
			<div class="col-md-10 column right"
				...
				<div class="row clearfix">
					...
					<form name="Form1" class="col-md-8"
						action="${pageContext.request.contextPath}/studentAccount/edit"
						method="post">
							...
							<tbody>
								<tr>
									...
									<td align="center" width="12%"><input type="text"
										class="form-control" name="account" value="${n.account }">
									</td>
								</tr>
								<tr>
									<td align="center" width="8%" class="table-left"
									...
									<td align="center" width="12%"><input type="text"
										class="form-control" name="password" value="${n.password }">
									</td>
								</tr>
