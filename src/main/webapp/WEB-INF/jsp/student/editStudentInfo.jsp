		...
		<div class="row clearfix" style="height: 140vh;">
			<div class="col-md-2 column left" style="height: 140vh;">
				<ul class="nav nav-stacked nav-pills">
					<li><a href="../studentInfo/show">基本信息</a></li>
					<li class="active"><a href="../auditList/addForm">修改信息</a></li>
				</ul>
			</div>
			<div class="col-md-10 column right"
				...
				<div class="row clearfix">
					...
					<form name="Form1" class="col-md-8"
						action="${pageContext.request.contextPath}/auditList/add"
						method="post">
						<table class="table table-hover">
							<tbody>
								...
								<tr>
									...
									<td align="center" width="12%"><input type="text"
										class="form-control" name="name" value="${n.name }"></td>
								</tr>
								<tr>
									<td align="center" width="8%" class="table-left"
										style="vertical-align: middle;">性别</td>
									<td align="center" width="12%"><input type="text"
										class="form-control" name="sex" value="${n.sex }"></td>
								</tr>
								<tr>
									<td align="center" width="8%" class="table-left"
										style="vertical-align: middle;">年级</td>
									<td align="center" width="12%"><input type="text"
										class="form-control" name="grade" value="${n.grade }">
									</td>
								</tr>
								<tr>
									<td align="center" width="8%" class="table-left"
									...
									<td align="center" width="12%"><input type="text"
										class="form-control" name="college" value="${n.college }">
									</td>
								</tr>
								<tr>
									<td align="center" width="8%" class="table-left"
									...
									<td align="center" width="12%"><input type="text"
										class="form-control" name="major" value="${n.major }">
									</td>
								</tr>
								<tr>
									<td align="center" width="8%" class="table-left"
									...
									<td align="center" width="12%"><input type="text"
										class="form-control" name="class_" value="${n.class_ }">
									</td>
								</tr>
								<tr>
									<td align="center" width="8%" class="table-left"
									...
									<td align="center" width="12%"><input type="text"
										class="form-control" name="id" value="${n.id }"></td>
								</tr>
